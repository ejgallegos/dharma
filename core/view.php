...
abstract class View {
    ...
    function render_template($contenido) {
        ...
        $hidden_operador = ($user_level == 3 || $user_level == 9) ? "display: block;" : "display: none;";
        $contenido = str_replace('{hidden-operador}', $hidden_operador, $contenido);
